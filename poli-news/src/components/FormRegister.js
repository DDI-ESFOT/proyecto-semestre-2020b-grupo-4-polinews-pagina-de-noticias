...
const FormRegister = () => {
	...
	return (
		<>
			<Modal title="Formulario de Registro" visible={isModalVisible} footer={null} onCancel={handleCancel}>
				<Form
					{...formItemLayout}
					form={form}
					name="register"
				...
				>
					...
					<Form.Item name="password" label="Contraseña" rules={[{ required: true }]} hasFeedback>
						<Input.Password />
					</Form.Item>
					<Form.Item
						name="confirm"
					...
					<Form.Item name="phone" label="Numero de Telefono" rules={[{ required: true }]}>
						<Input
					...
					<Form.Item name="status" label="Tipo de usuario" rules={[{ required: true }]}>
						<Select
							showSearch
							style={{ width: 200 }}
							placeholder="Select type"
