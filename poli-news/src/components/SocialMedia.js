	...
	return (
		<Row justify="center">
			<Col className="socialMedia">
				...
				<a href="https://twitter.com/home?lang=es" target="_blank" rel="noreferrer noopener">
					<IconFont
						type="icon-twitter"
						style={{ fontSize: '80px', marginRight: '20%', display: 'inline-block' }}
					/>
				</a>
				<a href="https://www.youtube.com/watch?v=sAXBT_A0xGY" target="_blank" rel="noreferrer noopener">
